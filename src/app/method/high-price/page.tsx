...
export const metadata: Metadata = {
  title: 'ゲームを高く売る10のコツ｜高価買取のテクニック完全版【2025年】',
  description:
...
const tips = [
  { title: '本体・ソフトの清掃', effect: '5〜15%アップ', description: 'ホコリや指紋を拭き取るだけで印象が大きく変わります。綿棒でコネクター部分、マイクロファイバーでディスク面を清掃。コントローラーのスティック周りの汚れも忘れずに。' },
  { title: '付属品を全て揃える', effect: '10〜30%アップ', description: '箱、説明書、ケーブル類、コントローラーなど付属品が揃っているほど高額に。特に外箱の有無は大きな差が出ます。付属品が1つ欠けるごとに減額されるため、購入時から保管を意識しましょう。' },
  ...
  { title: '複数社で査定を比較する', effect: '10〜40%アップ', description: '1社だけで決めるのは損。ヒカカク！なら最大20社に一括査定でき、業者間の競争で最高値を引き出せます。同じ商品でも業者によって数千円の差がつくことも珍しくありません。' },
  ...
  { title: '新作は発売後早めに売る', effect: '20〜50%ダウン回避', description: 'ゲームソフトの価値は発売日から離れるほど下がります。クリア済みのゲームは早めに売却。発売から1ヶ月以内なら定価の60〜70%で売れることも。3ヶ月経つと一気に下落します。' },
  ...
  { title: '箱・説明書の状態を保つ', effect: '10〜25%アップ', description: '箱のつぶれ、説明書の折れ・書き込みは減額対象。購入後は箱を保護袋に入れ、説明書は箱と一緒に保管。レトロゲームでは箱・説明書の有無で10倍以上の差がつくこともあります。' },
