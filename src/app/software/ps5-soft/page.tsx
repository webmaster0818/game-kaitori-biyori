...
export const metadata: Metadata = {
  title: 'PS5ソフト買取おすすめ3選｜プレステ5ソフトを高く売るコツ【2026年】',
  description:
...
export default function PS5SoftPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": "PS5ソフト買取おすすめ3選｜プレステ5ソフトを高く売るコツ【2026年】", "datePublished": "2026-03-15", "dateModified": "2026-05-24", "author": {"@type": "Person", "name": "中村 大輝", "description": "ゲームコレクター歴15年、レトロゲーム買取査定経験者"}, "publisher": {"@type": "Organization", "name": "ゲーム買取びより"}}) }} />
