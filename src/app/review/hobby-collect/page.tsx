...
export const metadata: Metadata = {
  title: 'ホビーコレクトの評判・口コミは怪しい？箱なし・ジャンクでも高く売れる？【2026年8月】古物商番号で検証',
  description:
    'ホビーコレクトの評判・口コミは怪しい？箱なし・ジャンクでも高く売れる？に直答。古物商許可のある正規業者である実態、ヒカカク!4.13点の口コミ傾向、箱なし・ジャンク品の査定額、送料・返送料・キャンセル条件を公式情報（2026年8月7日再確認）で整理。あわせて当サイトが毎週実測する買取価格DBで、今どこが一番高いかも比較できます。おすすめできる人・できない人も明記。',
...
const faqs = [
  ...
  { q: '査定に納得できない場合は？', a: 'キャンセル可能です。ただし返送料は着払い(自己負担)です(2026年8月7日公式確認)。まとめて送る前に、高額になりそうな品はLINE査定等で目安を確認しておくと安心です。' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="glass-card p-6">
              ...
              <ul className="space-y-2 text-sm" style={{ color: 'var(--color-text-light)' }}>
                ...
                <li>+ 送りの送料・査定料は無料(キャンセル時の返送料のみ着払い)</li>
