...
export const metadata: Metadata = {
  ...
  description:
    'ホビーコレクトの評判・口コミは怪しい？箱なし・ジャンクでも高く売れる？に直答。古物商許可のある正規業者である実態、ヒカカク!4.13点の口コミ傾向、箱なし・ジャンク品の査定額、送料・返送料・キャンセル条件を公式情報（2026年6月確認）で整理。あわせて当サイトが毎週実測する買取価格DBで、今どこが一番高いかも比較できます。おすすめできる人・できない人も明記。',
