...
export const metadata: Metadata = {
  title: 'ソフマップ買取（ラクウル）の評判・口コミ【2026年7月】送料・返送料無料の実態と注意点',
  description:
  ...
  openGraph: {
    title: 'ソフマップ買取（ラクウル）の評判・口コミ【2026年7月】検証',
...
const faqs = [
  ...
  { q: 'キャンペーンはありますか？', a: '初回の宅配買取で+500円（店頭・出張は対象外）、誕生月は宅配買取が5%増額（月内何度でも）の2つが公式に案内されています（2026年7月7日確認）。ゲームカテゴリ対象の%増額キャンペーンは確認できませんでした。' },
