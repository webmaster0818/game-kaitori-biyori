...
export const metadata: Metadata = {
  title: 'カイトリワールドの評判・口コミは怪しい？【2026年8月】運営会社メディアワールドの実態・減額を検証',
  description:
    'カイトリワールドは怪しくない？結論：運営はゲーム専門店22年のメディアワールド株式会社（古物商許可306701605637）。気になる減額の基準、入金の速さ（査定は商品到着日・承諾後すぐ振込手続き）、送料無料の条件（査定3,000円以上・未満は500円差引）、7日自動承認ルール、申込価格を5日間保証する「価格保証買取」まで公式情報で直答します。毎週実測の買取価格DBで今どこより高いかも比較（2026年8月確認）。',
  keywords: ['カイトリワールド 評判', 'カイトリワールド 口コミ', 'カイトリワールド 怪しい', 'メディアワールド 怪しい', '買取ワールド 評判', 'カイトリワールド 入金'],
  openGraph: {
    title: 'カイトリワールドの評判・口コミは怪しい？【2026年8月】運営会社メディアワールドの実態を徹底解説',
